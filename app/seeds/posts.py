...
def seed_posts():
    ...
    posts = [
        Post(post="Stayed up all night watching film, now it's time to put in work on the court! #StriveForGreatness", user_id=1),
        ...
        Post(post="Officially certified goat after breaking the scoring record", image='https://media.licdn.com/media/AAYQAQQSAAgAAQAAAAAAABwEEXEeLoHISM2cU9LdzliLaQ.gif', user_id=1),
